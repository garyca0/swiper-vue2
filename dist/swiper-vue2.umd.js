(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["swiper-vue2"] = factory(require("vue"));
	else
		root["swiper-vue2"] = factory(root["Vue"]);
...
/* harmony default export */ var navigation_navigation = ({
  name: 'navigation',
  params: {
    navigation: {
      nextEl: null,
...
core_class.use([pagination_pagination, navigation_navigation]);
...
function renderLoop(h, swiperRef, slides, swiperParams) {
  ...
  function duplicateSlide(child, index, position) {
    if (!child.props) child.props = {};
    return h(child.componentOptions.tag, _objectSpread2(_objectSpread2({}, child.props), {}, {
      key: "".concat(child.key, "-duplicate-").concat(index, "-").concat(position),
      staticClass: "".concat(child.data.staticClass || '', " ").concat(swiperParams.slideDuplicateClass),
      class: child.data.class,
      attrs: _defineProperty({}, child.context.$options._scopeId, '')
...
function getChildren() {
  var originalSlots = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
  var slidesRef = arguments.length > 1 ? arguments[1] : undefined;
  var oldSlidesRef = arguments.length > 2 ? arguments[2] : undefined;
  var slides = [];
  var slots = {
    'container-start': [],
    'container-end': [],
...
function renderVirtual(h, swiperRef, slides, virtualData) {
  ...
  var style = swiperRef.value.isHorizontal() ? _defineProperty({}, swiperRef.value.rtlTranslate ? 'right' : 'left', "".concat(virtualData.offset, "px")) : {
  ...
  return slides.filter(function (slide, index) {
    ...
    return h(slide.type, _objectSpread2({}, slide.props), slide.children);
  });
}
...
var SwiperSlide = external_commonjs_vue_commonjs2_vue_root_Vue_default.a.extend({
  name: 'SwiperSlide',
  props: {
    tag: {
      type: String,
  ...
  computed: {
    slideElRef: function slideElRef() {
  ...
  methods: {
    updateClasses: function updateClasses(swiper, el, classNames) {
  ...
  render: function render(h) {
    ...
    return h(self.tag, {
      class: uniqueClasses("".concat(self.slideClasses)),
      ref: 'slide',
...
var swiper_Swiper = external_commonjs_vue_commonjs2_vue_root_Vue_default.a.extend({
  name: 'Swiper',
  components: {
  ...
  watch: {
    virtualData: function virtualData() {
      ...
      this.$nextTick(function () {
        updateOnVirtualData(_this.swiperRef);
      });
    }
  },
  created: function created() {
    ...
    var onBeforeBreakpoint = function onBeforeBreakpoint() {
      getChildren(scopedSlots, _this2.slidesRef, _this2.oldSlidesRef);
      _this2.breakpointChanged = true;
    };
    ...
    this.swiperRef.loopCreate = function () {};

    this.swiperRef.loopDestroy = function () {};
  ...
  updated: function updated() {
    var props = this.$props; // set initialized flag
    ...
    var _getParams3 = getParams(props),
        newPassedParams = _getParams3.passedParams;

    var changedParams = getChangedParams(newPassedParams, this.oldPassedParamsRef, this.slidesRef.value, this.oldSlidesRef.value);
  ...
  render: function render(h) {
    ...
    var slidesRefLoc = {
      value: _toConsumableArray(this.slidesRef.value)
    };
    var oldSlidesRefLoc = {
      value: _toConsumableArray(this.oldSlidesRef.value)
    };

    var _getChildren = getChildren(scopedSlots, slidesRefLoc, oldSlidesRefLoc),
        slides = _getChildren.slides,
        slots = _getChildren.slots; // bypass swiper instance to slides


    function renderSlides(slides) {
      var _self$swiperRef;

      var swiperParams = self.swiperRef.params;
...
//# sourceMappingURL=swiper-vue2.umd.js.map